...
class RomanianGroupLister(APIView):
    ...
    def post(self, request, format=None):
        serializer = RomanianGroupSerializers(data=request.data)
...
class RomanianGroupDetails(APIView):

    def get_post(self, pk):
        try:
            return RomanianGroup.objects.get(pk=pk)
        except:
            raise Http404

    def get(self, request, pk, format=None):
        post = self.get_post(pk)
        serializer = RomanianGroupSerializers(post)
...
class RomanianScheduleDetails(APIView):

    def get_post(self, pk):
        try:
            return RomanianSchedule.objects.get(pk=pk)
        except:
            raise Http404

    def get(self, request, pk, format=None):
        post = self.get_post(pk)
        serializer = RomanianScheduleSerializers(post)
...
class RomanianHomeworkLister(APIView):
    ...
    def post(self, request, format=None):
        serializer = RomanianHomeworkSerializers(data=request.data)
...
class RomanianHomeworkDetails(APIView):

    def get_post(self, pk):
        try:
            return RomanianHomework.objects.get(pk=pk)
        except:
            raise Http404

    def get(self, request, pk, format=None):
        post = self.get_post(pk)
        serializer = RomanianHomeworkSerializers(post)
